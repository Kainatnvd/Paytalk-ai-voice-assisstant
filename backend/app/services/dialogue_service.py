...
VALID_STATES = {"IDLE", "AWAITING_CONFIRMATION", "AWAITING_PIN", "AWAITING_OTP", "EXECUTING", "COMPLETE", "AWAITING_PAYMENT_METHOD", "AWAITING_RAAST_ID", "AWAITING_REFERENCE_NUMBER", "AWAITING_ACCOUNT_TYPE", "AWAITING_BANK_NAME", "AWAITING_ACCOUNT_NUMBER"}
